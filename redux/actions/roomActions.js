...
export const getRooms = (req, currentPage = 1, location='', guests, category) => async(dispatch) => {
    try {
        ...
        dispatch({
            ...
            //here read propert 'data' of undefined was given so i manually give the data for error payload
            // payload: ((error || {}).response || {}).data || 'Error Unxpected'  
        })
    }
...
//action for the user to put review iff the user has booked the particular room
...
//get room review action by the admin
...
//delete the review action by the admin
